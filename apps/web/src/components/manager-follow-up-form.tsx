    ...
    <form action={action} className="form-stack">
      ...
      <div className="field-grid">
        <label className="field-stack field-span-full">
          ...
          <textarea className="textarea-shell" defaultValue={props.nextAction} name="nextAction" required rows={4} />
        </label>
        <label className="field-stack">
          <span>{copy.nextActionDueAt}</span>
          <input className="input-shell" defaultValue={toDateTimeLocalValue(props.nextActionDueAt)} name="nextActionDueAt" required type="datetime-local" />
        </label>
        <label className="field-stack">
